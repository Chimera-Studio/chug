...
const MainBG = forwardRef((props, ref) => {
  ...
  function initBubbles() {
    ...
    for (var i = 0; i < bubblesOnScreen / 2; i++) {
      ...
      obj30["bottom"] = Math.floor(Math.random() * (deviceHeight - 0)) + 0;
      obj30["width"] = width30;
      obj30["speed"] =
      ...
      obj50["bottom"] = Math.floor(Math.random() * (deviceHeight - 0)) + 0;
      obj50["width"] = width50;
      obj50["speed"] =
        Math.floor(Math.random() * (maxBubbleSpeed - minBubbleSpeed)) +
        minBubbleSpeed;
  ...
  function float() {
    for (var i = 0; i < bubbles30.length; i++) {
      ...
      if (newY30 >= deviceHeight) {
        ...
        bubbles30[i].left = Math.floor(Math.random() * (deviceWidth - 0)) + 0;
        bubbles30[i].speed =
          Math.floor(Math.random() * (maxBubbleSpeed - minBubbleSpeed)) +
          minBubbleSpeed;
      } else if (newY50 >= deviceHeight) {
        bubbles50[i].bottom = 0;
        bubbles50[i].left = Math.floor(Math.random() * (deviceWidth - 0)) + 0;
        bubbles50[i].speed =
          Math.floor(Math.random() * (maxBubbleSpeed - minBubbleSpeed)) +
          minBubbleSpeed;
      } else {
