...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    marginTop: Platform.OS === "ios" && !Platform.isPad ? "5%" : 0,
    marginBottom: 0,
    marginHorizontal: "5%",
  ...
  ads: {
    position: "absolute",
    bottom: Platform.OS === "ios" && !Platform.isPad ? "5%" : 0,
    display: "flex",
  ...
  inputFieldBtnTxt: {
    fontFamily: "PrimaryFont",
    fontSize: 40,
    lineHeight: Platform.OS === "ios" ? 36 : 42,
    textAlign: "center",
    color: colors.white,
  },
  savePresetBtn: {
  ...
  rewardedWrapper: {
    marginTop: Platform.OS === "ios" && !Platform.isPad ? 0 : "15%",
    flex: 1,
    display: "flex",
    alignItems: "center",
